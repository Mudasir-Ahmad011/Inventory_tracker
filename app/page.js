...
return (
    <>
    <Box width="100vw" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap={2} bgcolor="lightgray">
      ...
      <Stack width="800px" height="100px">
      <Box width="100%" minHeight="100px" display="flex" alignItems="center" justifyContent="center" gap={2}>
      <TextField
          variant="outlined"
